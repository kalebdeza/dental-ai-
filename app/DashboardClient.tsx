...
function isDashboardData(value: unknown): value is DashboardData {
  ...
  const candidate = value as DashboardData;

  return (
    typeof candidate.totalRecoverableRevenue === "number" &&
...
export default function DashboardClient() {
  ...
  if (needsOnboarding) {
    return (
      <main className="rounded-2xl bg-white p-10 shadow-sm">
        <h2 className="text-2xl font-bold">Set up your practice</h2>
        <p className="mt-2 text-slate-500">
          Your account does not have a practice yet. Continue to onboarding
          to create one.
        </p>
        <Link
          href="/onboarding"
